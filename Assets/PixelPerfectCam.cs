...
public class PixelPerfectCam : MonoBehaviour
{
	...
	public void FixedUpdate()
	{
		...
		if (_camera && followTarget)
		{
			...
			_camera.transform.position = Vector3.Lerp(_camera.transform.position, new Vector3(nextX / _pixelLockedPPU, nextY / _pixelLockedPPU, _camera.transform.position.z), 5 * Time.deltaTime);
		}
	}
}